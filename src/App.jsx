...
import LogoIcon from './icon-teal-600.svg?react';
import { 
  BookOpen, 
  Users, 
  BarChart3, 
...
const Memorize = () => {
  ...
  const pricingTiers = [
    ...
    {
      name: "Network",
      subtitle: "Multi-Branch Networks",
      price: "Custom",
      period: "pricing",
      features: [
        "Unlimited students",
  ...
  const stats = [
    { number: "50K+", label: "Students Learning", icon: <Users className="w-6 h-6" /> },
    { number: "500+", label: "Institutions", icon: <Building className="w-6 h-6" /> },
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center group">
                                <LogoIcon className="h-12 w-auto group-hover:scale-110 transition-transform" />
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full mb-8 group hover:bg-emerald-500/20 transition-all">
              <Zap className="w-4 h-4 text-emerald-400 mr-2" />
              <span className="text-emerald-400 text-sm font-medium">Next-Generation Learning Platform</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-slate-400 mb-12 max-w-4xl mx-auto leading-relaxed">
              Empower your institution with AI-powered progress tracking, real-time analytics, 
              and seamless collaboration tools designed for modern Islamic education.
            </p>
              ...
              {stats.map((stat, index) => (
                <div key={index} className="text-center group">
                  <div className="flex justify-center mb-2">
                    <div className="p-3 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-lg group-hover:scale-110 transition-transform">
                      {stat.icon}
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
              Traditional methods fall short in today's digital age. We've built the future of Islamic education management.
            </p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-slate-700/50 hover:border-emerald-500/50 transition-all duration-300 hover:scale-105">
              ...
              <p className="text-slate-400 leading-relaxed">Advanced algorithms monitor every ayah, providing unprecedented accuracy in progress measurement and retention analytics.</p>
            </div>
            
            <div className="group p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300 hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Unified Ecosystem</h3>
              <p className="text-slate-400 leading-relaxed">Connect students, teachers, parents, and administrators in one seamless platform with role-based access controls.</p>
            </div>
            
            <div className="group p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 hover:scale-105">
              <div className="bg-gradient-to-r from-purple-500 to-violet-600 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <TrendingUp className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Smart Insights</h3>
              <p className="text-slate-400 leading-relaxed">AI-powered analytics reveal learning patterns, predict challenges, and recommend personalized improvement strategies.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">
              Everything you need to manage, track, and enhance Quranic memorization at scale.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="group p-6 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-xl border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className={`bg-gradient-to-r ${feature.gradient} w-14 h-14 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
                  {feature.icon}
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="relative group">
                <div className="p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300 hover:scale-105">
      ...
      <section id="pricing" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">
              Flexible pricing that grows with your institution's needs.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {pricingTiers.map((tier, index) => (
              <div key={index} className={`relative p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border transition-all duration-300 hover:scale-105 ${
                tier.recommended 
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-emerald-100 mb-12 max-w-3xl mx-auto">
            Join thousands of institutions worldwide using Memorize to revolutionize Islamic education.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center mb-6">
                ...
                <span className="ml-3 text-2xl font-bold bg-gradient-to-r from-emerald-400 to-teal-300 bg-clip-text text-transparent">
                  Memorize
                </span>
              </div>
